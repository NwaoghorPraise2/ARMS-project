...
class WorkloadGenerator:
    ...
    def run_balanced_workload(self, total_duration_seconds=3600, interval_seconds=5, total_messages=2160000):
        """
        ...
        Args:
            ...
            interval_seconds: Time to spend on each workload before switching (default: 5 seconds)
    ...
    try:
        if workload_type == "real_time":
            ...
            generator.run_balanced_workload(
                ...
                interval_seconds=5,  # Using 5-second intervals by default
                total_messages=total_messages
            )
    except Exception as e:
